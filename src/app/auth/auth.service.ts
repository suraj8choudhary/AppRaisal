...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-759510:/callback' : 'http://localhost:8101/implicit/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-759510:/logout' : 'http://localhost:8101/implicit/logout';
    const clientId = '0oa1lsr67pJ6XNsYW357';
    const issuer = 'https://dev-759510.okta.com/oauth2/default';
